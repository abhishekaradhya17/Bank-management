...
<div class="container">
  ...
  <div class="card-body">
      ...
      {
        $array2 = $conn->query("select * from otheraccounts where accountNo = '$_POST[otherNo]'");
        $array3 = $conn->query("select * from useraccounts where accountNo = '$_POST[otherNo]'");
        {
    ...
    if (isset($_POST['transfer']))
    {
      ...
      $array = $conn->query("select * from transaction where userId = '$userData[id]' AND action = 'transfer' order by date desc");
      if ($array ->num_rows > 0) 
      {
