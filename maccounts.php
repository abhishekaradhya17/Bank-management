...
{
  if (!$conn->query("insert into login (email,password,type) values ('$_POST[email]','$_POST[password]','cashier')")) {
    echo "<div claass='alert alert-success'>Failed. Error is:".$conn->error."</div>";
  }
}
if (isset($_GET['del']) && !empty($_GET['del']))
{
  $conn->query("delete from login where id ='$_GET[del]'");
}
  $array = $conn->query("select * from login where type='cashier'");
